...
const ExerciseTrackingCard = ({
  ...
  return (
    <View
      style={[style.exerciseTrackingCardContainer, {backgroundColor, opacity}]}>
      <View style={style.exerciseDetailsContainer}>
        <View style={style.dateConatiner}>
          <View
            style={[
              style.dateImageContainer,
          ...
          <View>
            <View style={style.repSetContainer}>
              <View
                style={[
                  style.repsSetBox,
                  {backgroundColor: setsRepsBackgroundColor},
                ]}>
                <ThemeText
                  fontType="primary"
                  fontStyle="medium"
                  fontSize="small"
                  fontColor="primary">{`${sets} sets`}</ThemeText>
              </View>
              <View
                style={[
                  style.repsSetBox,
                ...
                <ThemeText
                  ...
                  fontStyle="medium"
                  fontSize="small"
                  fontColor="primary">{`${reps} reps`}</ThemeText>
              </View>
            </View>
      ...
      <View
        style={[
          style.exerciseImageConatiner,
          {
            borderLeftColor: theme.colors.background.quaternary.secondary,
            borderLeftWidth: 2,
          },
        ]}>
        <Image
